...
Nic = 4; %(1 = turb; 2 = tilted vorts; 3 = baroclinic instability; 4 =
         %Gaussian, 11 = turb w/ no baro flow!, 5 = 2 vorts, 6 =
         %edge wave, 7 = topo wave)
...
%  th_init.dat
fid     = fopen('./th_init_B.dat','w');
fprintf(fid,'%i\n',Nx);
fprintf(fid,'%i\n',Ny);
fprintf(fid,'%f\n',th_B);
fclose(fid);
fid     = fopen('./th_init_T.dat','w');
fprintf(fid,'%i\n',Nx);
fprintf(fid,'%i\n',Ny);
fprintf(fid,'%f\n',th_T);
fclose(fid);
